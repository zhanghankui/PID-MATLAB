...
delta = 10;
%ESO parameters
beta1=150;beta2=300;beta3=1000;%比前面写的值少了一半
delta1=0.0025;
...
for k=1:1:2000
    ...
    p2=k*h;%time
    tSpan=[0 h];%0到0.01
    [tt,xx]=ode45('chap6_12plant',tSpan,xk,[],p1,p2);%plant 计算
    xk=xx(length(xx),:);%取最后一行
    y(k)=xk(1);%plant 输出y
    dy(k)=xk(2);%plant 输出dy
    ...
    z3_1=z3(k);
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %N-PD and disturbance compensation 非线性组合
